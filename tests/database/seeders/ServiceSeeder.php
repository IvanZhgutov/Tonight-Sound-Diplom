...
class ServiceSeeder extends Seeder
{
    public function run(): void
    {
        $services = [
            ...
            ['slug' => 'arrange',   'name' => 'Аранжировка',        'price' => 8000, 'hourly' => false, 'bookable' => true,  'icon' => '🎛️', 'description' => 'Соберём аранжировку под ваш референс или с нуля: бит, гармония, структура и продакшн до состояния «можно записывать вокал».'],
